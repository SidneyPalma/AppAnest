...
Ext.define( 'AppAnest.controller.App', {
    ...
    setUserComein: function (btn) {
        ...
        fm.submit({
            ...
            params: {
                ...
                fields: Ext.encode(['id','username','fullname','password','isactive'])
            },
    ...
    setMainHome: function () {
        ...
        Ext.Ajax.request({
            ...
            success: function(response){
                var opened = Ext.decode(response.responseText);
                ...
                me.getMainTool().setVisible(opened.success);
                me.getMainDock().setVisible(opened.success);
